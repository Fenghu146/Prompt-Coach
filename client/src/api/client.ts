...
export const api = {
  ...
  confirmRule: (caseId:string, ruleId:string, body?:unknown) => req<import("@prompt-coach/shared").LearnedRule>(`/api/cases/${caseId}/rules/${ruleId}/confirm`,{method:"POST", body: JSON.stringify(body||{})}),
